...
export { RUSSIAN_STUDENT_SPEECH_WORDS_PER_MINUTE, RUSSIAN_STUDENT_SPEECH_TIMING_PRESETS, getRussianStudentSpeechTimingBudget, getRussianStudentSpeechSectionBounds, russianSpeechMinutesFromWords } from "./generation/speech-timing.js";
