import {
    getRussianStudentSpeechTimingBudget, russianSpeechMinutesFromWords,
    type SlideNarrative
} from "@studydeck/shared";
import { logger } from "../../../observability.js";
import { recordAiUsage } from "../../../usage-ledger.js";
...
import { GENERIC_NARRATION_PHRASES } from "../constants.js";
import { buildFallbackSpeakerNotes, buildNarrationFromContent, buildSlideNarration, emptyVisual, fallbackSlideText, fallbackTitle, sentenceCount, sentenceEdgeKey, speechSentences } from "../normalization/presentation.js";
import { getYandexModelConfig, type YandexModelTier } from "../prompts/builders.js";
import { hasForbiddenTemplateText, looksLikeSentenceFragment, normalizeExactForQuality, normalizeForQuality, qualityIssuesForText, significantTokens, textSimilarity } from "../quality/orchestration.js";
 ...
 * section floors: the project's requested slide total is authoritative and role targets are
...
export function assessFullNarrationDocument(value: unknown, project: ProjectInput, narrativePlan: SlideNarrative[] = []): FullNarrationSafeDiagnostics {
  ...
  // they do not make a complete draft structurally unusable.
